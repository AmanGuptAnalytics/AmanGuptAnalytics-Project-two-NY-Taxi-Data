...
DATASET = "tripdata"
COLOUR_RANGE = {'yellow': ['tpep_pickup_datetime','airport_fee'] , 'green': ['lpep_pickup_datetime','ehail_fee']}
INPUT_PART = "raw"
...
with DAG(
    ...
    for colour, ds_col in COLOUR_RANGE.items():
        ...
        CREATE_BQ_TBL_QUERY = (
            ...
            PARTITION BY DATE({ds_col[0]}) \
            AS \
            SELECT * except({ds_col[1]}) FROM {BIGQUERY_DATASET}.{colour}_{DATASET}_external_table;"
        )
